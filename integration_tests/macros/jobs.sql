{% macro jobs() %}
{% set create_table %}
create or replace table {{ var('dag_monitoring_databricks_database')}}.{{ var('dag_monitoring_databricks_schema') }}.jobs (
    created_time BIGINT,
...
INSERT INTO {{ var('dag_monitoring_databricks_database')}}.{{ var('dag_monitoring_databricks_schema') }}.jobs VALUES
(
